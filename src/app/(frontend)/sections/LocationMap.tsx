    ...
    <section className="py-28 bg-[#080B10] border-t border-white/10 relative overflow-hidden" id="location">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Map Embed Frame */}
          <div className="lg:col-span-2 rounded-3xl overflow-hidden border border-white/10 aspect-video lg:aspect-auto min-h-[400px] relative bg-slate-900 shadow-2xl">
            {mapUrl ? (
              <iframe
                src={mapUrl}
                width="100%"
          ...
          {/* Transit & Proximity */}
          <div className="awwwards-card rounded-3xl p-8 flex flex-col justify-between h-full">
            <div>
