                  ...
                  {item.isVideo ? (
                    <div className="w-full h-full relative">
                      {getYoutubeId(mediaUrl) ? (
                        <iframe
                          src={`https://www.youtube.com/embed/${getYoutubeId(mediaUrl)}?autoplay=1&mute=1&loop=1&playlist=${getYoutubeId(mediaUrl)}&controls=0&modestbranding=1&playsinline=1&rel=0&enablejsapi=1`}
                      ...
                      {/* Transparent click receiver to trigger spotlight */}
                  ...
                  if (ytId) {
                    return (
                      <iframe
                        ...
                        className="rounded-2xl w-[90vw] h-[50vh] md:w-[70vw] md:h-[60vh] max-w-full max-h-[80vh] shadow-2xl border border-white/10"
                        frameBorder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                        allowFullScreen
                      />
